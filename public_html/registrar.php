...
<div class="log">
    <img src="img/logo.png" alt="Logo MHVWare" height="200" width="200">
</div>
<?php
...
if ($_POST["metodo"] == "registrar") {
    ...
    $sql = "INSERT INTO cuenta
          VALUES(default, '$usuario', '$correo', '$contra', '$pregunta', '$respuesta', '$nombre', default)";
    $resultado = $conexion->query($sql);
